...
CREATE PROCEDURE 
PARTITION ON TABLE Store COLUMN key PARAMETER 1
FROM CLASS com.procedures.Put;

CREATE PROCEDURE 
PARTITION ON TABLE Store COLUMN key
FROM CLASS com.procedures.ScanPartitionKey;
